---
title: 'Foundations for Statistical Inference - Sampling Distributions (Lab 4)'
output:
  html_document:
    css: ../lab.css
    highlight: pygments
...
Please complete the **Foundations for Statistical Inference (Lab 04)** quiz on Canvas. The quiz questions mirror those provided throughout this lab.
...
living area of the the population, and the spread of the sampling distribution
