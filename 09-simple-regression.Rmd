...
> **Exercise 3:** Using `plot_ss`, choose a line that does a good job of minimizing the sum of
...
> **Exercise 4:** Fit a new model that uses `homeruns` to predict `runs`. Using the estimates
...
> **Exercise 6:** Is there any apparent pattern in the residuals plot? What does this indicate
...
> **Exercise 8:** Based on the plot, does the constant variability condition appear to
    be met?
