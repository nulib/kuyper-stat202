...
Please complete the **Introduction to Data (Lab 02)** quiz on Canvas. The quiz questions mirror those provided throughout this lab.
...
-   Now it's time to get creative. Find the mean and standard deviation of
    `weight` and determine what proportion of the weights that are within one
